...
wss.on('connection', async (ws, req) => {
  ...
  try {
    ...
    // Note: WebSocket is disabled in favor of HTTP polling for chat
    // Redis pub/sub with Upstash REST API is not directly supported
    // Using in-memory broadcasting for now
