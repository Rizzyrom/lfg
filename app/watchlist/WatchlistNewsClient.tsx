...
export default function WatchlistNewsClient() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-tv-text mb-2">Watchlist</h1>
      ...
      <div className="card p-4 mb-6">
        <h2 className="text-lg font-semibold text-tv-text mb-3">Add to Watchlist</h2>
        <form onSubmit={handleAdd} className="flex gap-2">
          ...
          <button type="submit" disabled={adding} className="btn btn-primary px-6">
            {adding ? 'Adding...' : 'Add'}
          </button>
        </form>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Other Market News */}
          <div>
            <h2 className="text-xl font-bold text-tv-text mb-4">Market News</h2>
            <div className="space-y-3">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs px-2 py-0.5 rounded bg-tv-chip text-tv-text-soft font-medium">
                          {article.source}
                        </span>
                        <span className="text-xs text-tv-text-soft">
                          {getTimeAgo(article.publishedAt)}
                      ...
                      {article.description && (
                        <p className="text-sm text-tv-text-soft line-clamp-1">
                          {article.description}
                        </p>
                      )}
                    </div>
